...
TaskHandle_t blue_handle, red_handle;
uint32_t blue_priority, red_priority;
...
void vBlueLedControllerTask(void *pvParameters){
	...
	while(1){
		BlueTaskProfiler ++;
		red_priority = uxTaskPriorityGet(red_handle);
	}
}
...
void vRedLedControllerTask(void *pvParameters){
	...
	while(1){
		RedTaskProfiler ++;
		blue_priority = uxTaskPriorityGet(blue_handle);
