...
TaskHandle_t blueTaskHandle, greenTaskHandle, redTaskHandle;
...
int main(void)
{
  ...
  vTaskCreate(redTask, "redTask", 256, NULL, 1, redTaskHandle);
  vTaskCreate(greenTask, "greenTask", 256, NULL, 1, greenTaskHandle);
  vTaskCreate(blueTask, "blueTask", 256, NULL, 1, blueTaskHandle);
